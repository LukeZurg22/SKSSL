...
public class Triangle
{
    ...
    public IEnumerable<Triangle> TrianglesWithSharedEdge
    {
        get
        {
            ...
            {
                var trianglesWithSharedEdge = vertex.AdjacentTriangles
                    .Where(o => o != this && SharesEdgeWith(o));
    ...
    /// is SharedVertices == 2 ?
    private bool SharesEdgeWith(Triangle triangle) => Vertices.Count(o => triangle.Vertices.Contains(o)) == 2;

    public bool IsPointInsideCircumcircle(Point point)
    {
        var d_squared =
            (point.X - Circumcenter.X) * (point.X - Circumcenter.X) +
