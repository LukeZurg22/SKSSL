...
public static class CommandFactory
{
    public static List<IConsoleCommand> CreateCommands()
    {
        ...
        // Find all types in the assembly that have the [RegisterCommand] attribute and implement ICommand
        var commandTypes = assembly.GetTypes()
            .Where(t => t.GetCustomAttribute<RegisterCommandAttribute>() != null && commandType.IsAssignableFrom(t))
            .ToList();
