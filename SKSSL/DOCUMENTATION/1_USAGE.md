...
be used freely without the others. However, certain parts require the ECS to be enabled!

Additionally, SKSSL expects `textures`, `prototypes`, `localization`, etc. folders defined in its loaded directories.
